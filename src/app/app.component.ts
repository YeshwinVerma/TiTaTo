...
export class AppComponent implements OnInit{
  ...
  reformBoard():Array<Array<string>>{
    let value = [[this.board[0],this.board[1],this.board[2]],[this.board[3],this.board[4],this.board[5]],[this.board[6],this.board[7],this.board[8]]];
    return value;
  }
  ...
  minmax(board:Array<Array<string>>,depth:number,isMaximizing:boolean):number{
